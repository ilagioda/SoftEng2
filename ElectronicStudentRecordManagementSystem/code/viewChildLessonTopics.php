...
<script>
	...
	function showLectures($date, $text) {
        ...
        // insert new cards
        var lectures = document.getElementById("lectureList");
        var str = "";
        let rows = $text.split("~");
...
$lectures = $db->viewChildLectures($_SESSION['child']);
...
echo <<<_TITLE
    ...
    <div class="text-center">
        <h1>$_SESSION[childName] $_SESSION[childSurname]'s lectures</h1>
        <br>
