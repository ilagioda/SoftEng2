...
<script type='text/javascript'>
	...
	function changeVisibility(){
		...
		if(state === "none"){
			document.getElementById("tableParent2").style.display = "block";
...
<div class="centralDiv">
	...
	<br><button type="button" onclick="changeVisibility()"> PARENT 2 </button><br>
	<table class="enrollTable" id="tableParent2" style="display: none;">
		...
		<tr><td><label for="surname2">Surname: </label></td><td><input type="text" size="50" name="surname2" id="surname2" placeholder="Enter the parent 2's surname" autocomplete="off" title="Enter the student's surname"></td>
		<tr><td><label for="codfisc2">SSN code: </label></td><td><input type="text" size="50" name="codfisc2" id="codfisc2" placeholder="Enter the parent 2's SSN code" autocomplete="off" title="Enter the student's SSN code"></td>
